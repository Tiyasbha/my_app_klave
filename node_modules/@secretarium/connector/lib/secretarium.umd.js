(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Secretarium"] = factory(require("ws"));
	else
		root["Secretarium"] = factory(root["ws"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE__836__) {
...
exports.crypto = exports.Utils = void 0;
exports.Utils = __webpack_require__(223);
const secretarium_crypto_1 = __webpack_require__(212);
exports.crypto = secretarium_crypto_1.default;
exports["default"] = secretarium_crypto_1.default;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const msrCrypto_1 = __webpack_require__(68);
const selectCrypto = () => {
    const windowCrypto = typeof window !== 'undefined' ? window.crypto : undefined;
    return windowCrypto || msrCrypto_1.default;
};
exports["default"] = selectCrypto();
//# sourceMappingURL=secretarium.crypto.js.map
...
const js_base64_1 = __webpack_require__(575);
...
var msrCrypto = function () {
    ...
    if (typeof operations !== "undefined") {
        msrcryptoKdf.deriveKey = function (p) {
            ...
            var alg = p.algorithm;
            var otherInfo = utils.toArray(alg.algorithmId).concat(utils.toArray(alg.partyUInfo), utils.toArray(alg.partyVInfo), utils.toArray(alg.publicInfo), utils.toArray(alg.privateInfo));
    ...
    var msrcryptoHkdf = (function () {
        function deriveBits(p) {
            var algorithm = p.algorithm, keyBytes = p.keyData, bits = p.length, saltBytes = algorithm.salt, byteLen = Math.ceil(bits / 8), hLen, output = [], infoBytes = msrcryptoUtilities.toArray(algorithm.info), t = [], i, hmacContext;
            switch (algorithm.hash.name.toUpperCase()) {
                case "SHA-1":
                    hLen = 20;
                    break;
...
__webpack_require__.d(__webpack_exports__, {
  "Constants": () => (/* reexport */ secretarium_constant_namespaceObject),
  "Key": () => (/* reexport */ Key),
  "SCP": () => (/* reexport */ SCP),
  "Utils": () => (/* reexport */ src.Utils),
  "crypto": () => (/* reexport */ src["default"])
});

// NAMESPACE OBJECT: ./src/secretarium.constant.ts
var secretarium_constant_namespaceObject = {};
__webpack_require__.r(secretarium_constant_namespaceObject);
__webpack_require__.d(secretarium_constant_namespaceObject, {
...
;// CONCATENATED MODULE: ./src/secretarium.constant.ts


var _ErrorMessage, _ConnectionStateMessa;
...
(function (ErrorCodes) {
  ErrorCodes[ErrorCodes["EKEYISENC"] = 0] = "EKEYISENC";
  ErrorCodes[ErrorCodes["ESCPNOTRD"] = 1] = "ESCPNOTRD";
  ErrorCodes[ErrorCodes["EINPASSWD"] = 2] = "EINPASSWD";
  ErrorCodes[ErrorCodes["ETRANSFIL"] = 3] = "ETRANSFIL";
  ErrorCodes[ErrorCodes["ETIMOCHEL"] = 4] = "ETIMOCHEL";
  ErrorCodes[ErrorCodes["ETIMOCPOW"] = 5] = "ETIMOCPOW";
  ErrorCodes[ErrorCodes["ETINSRVID"] = 6] = "ETINSRVID";
  ErrorCodes[ErrorCodes["ETINSRVIC"] = 7] = "ETINSRVIC";
  ErrorCodes[ErrorCodes["ETINUSRKY"] = 8] = "ETINUSRKY";
  ErrorCodes[ErrorCodes["ETIMOCPOI"] = 9] = "ETIMOCPOI";
  ErrorCodes[ErrorCodes["ETINSRVPI"] = 10] = "ETINSRVPI";
  ErrorCodes[ErrorCodes["EUNABLCON"] = 11] = "EUNABLCON";
  ErrorCodes[ErrorCodes["ENOTCONNT"] = 12] = "ENOTCONNT";
  ErrorCodes[ErrorCodes["EINVKFORM"] = 13] = "EINVKFORM";
  ErrorCodes[ErrorCodes["EINVKNAME"] = 14] = "EINVKNAME";
  ErrorCodes[ErrorCodes["EUNSPKMIS"] = 15] = "EUNSPKMIS";
  ErrorCodes[ErrorCodes["EUNSPEXPS"] = 16] = "EUNSPEXPS";
  ErrorCodes[ErrorCodes["EKEYLDFAI"] = 17] = "EKEYLDFAI";
  ErrorCodes[ErrorCodes["EKEYNOTEC"] = 18] = "EKEYNOTEC";
  ErrorCodes[ErrorCodes["EXORNOTSS"] = 19] = "EXORNOTSS";
  ErrorCodes[ErrorCodes["EKEYNOTSL"] = 20] = "EKEYNOTSL";
  ErrorCodes[ErrorCodes["EECDHGENF"] = 21] = "EECDHGENF";
})(ErrorCodes || (ErrorCodes = {}));

var ErrorMessage = (_ErrorMessage = {}, _defineProperty(_ErrorMessage, ErrorCodes.EKEYISENC, 'Key is encrypted'), _defineProperty(_ErrorMessage, ErrorCodes.ESCPNOTRD, 'Cannot encrypt, SCP session is not ready'), _defineProperty(_ErrorMessage, ErrorCodes.EINPASSWD, 'Cannot decrypt, Invalid password'), _defineProperty(_ErrorMessage, ErrorCodes.ETRANSFIL, 'Transaction failed'), _defineProperty(_ErrorMessage, ErrorCodes.ETIMOCHEL, 'Timeout after client hello'), _defineProperty(_ErrorMessage, ErrorCodes.ETIMOCPOW, 'Timeout after client proof-of-work'), _defineProperty(_ErrorMessage, ErrorCodes.ETINSRVID, 'Invalid server identity'), _defineProperty(_ErrorMessage, ErrorCodes.ETINSRVIC, 'Invalid server identity chain at #'), _defineProperty(_ErrorMessage, ErrorCodes.ETINUSRKY, 'Invalid user key'), _defineProperty(_ErrorMessage, ErrorCodes.ETIMOCPOI, 'Timeout after client proof-of-identity'), _defineProperty(_ErrorMessage, ErrorCodes.ETINSRVPI, 'Invalid server proof-of-identity'), _defineProperty(_ErrorMessage, ErrorCodes.EUNABLCON, 'Unable to create the secure connection: '), _defineProperty(_ErrorMessage, ErrorCodes.ENOTCONNT, 'Not connected'), _defineProperty(_ErrorMessage, ErrorCodes.EINVKFORM, 'Key format is incorrect'), _defineProperty(_ErrorMessage, ErrorCodes.EINVKNAME, 'Invalid key name'), _defineProperty(_ErrorMessage, ErrorCodes.EUNSPKMIS, 'Unsupported, missing key file'), _defineProperty(_ErrorMessage, ErrorCodes.EUNSPEXPS, 'Unsupported, expecting a single key file'), _defineProperty(_ErrorMessage, ErrorCodes.EKEYLDFAI, 'Failed to load the key file'), _defineProperty(_ErrorMessage, ErrorCodes.EKEYNOTEC, 'Cannot save, key must be encrypted'), _defineProperty(_ErrorMessage, ErrorCodes.EXORNOTSS, 'Array should have the same size'), _defineProperty(_ErrorMessage, ErrorCodes.EKEYNOTSL, 'Key has not been sealed'), _defineProperty(_ErrorMessage, ErrorCodes.EECDHGENF, 'ECDH Key generation has failed'), _ErrorMessage);
var ConnectionState;
...
var ConnectionStateMessage = (_ConnectionStateMessa = {}, _defineProperty(_ConnectionStateMessa, ConnectionState.connecting, 'Secure Connection in Progress'), _defineProperty(_ConnectionStateMessa, ConnectionState.secure, 'Secure Connection Established'), _defineProperty(_ConnectionStateMessa, ConnectionState.closing, 'Secure Connection Failed'), _defineProperty(_ConnectionStateMessa, ConnectionState.closed, 'Closed'), _ConnectionStateMessa);
...
// EXTERNAL MODULE: ./node_modules/@secretarium/crypto/src/index.js
var src = __webpack_require__(221);
;// CONCATENATED MODULE: ./src/secretarium.key.ts
...
var CURRENT_KEY_VERSION = 2;
var Key = /*#__PURE__*/function () {
  function Key(keyPair, encryptedKeyPair) {
    _classCallCheck(this, Key);

    _defineProperty(this, "_cryptoKeyPair", void 0);

    _defineProperty(this, "_exportableKey", void 0);

    _defineProperty(this, "_exportableEncryptedKey", void 0);

    _defineProperty(this, "_rawPublicKey", void 0);
  ...
  _createClass(Key, [{
    key: "getCryptoKeyPair",
    value: function getCryptoKeyPair() {
      return this._cryptoKeyPair;
    }
  }, {
    key: "seal",
    value: function () {
      var _seal = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(pwd) {
        var salt, iv, weakPwd, strongPwd, key, keyPair, data, encrypted;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                salt = src.Utils.getRandomBytes(32);
                iv = src.Utils.getRandomBytes(12);
                weakPwd = src.Utils.encode(pwd);
                _context.next = 7;
                return src.Utils.hash(src.Utils.concatBytes(salt, weakPwd));

              case 7:
                strongPwd = _context.sent;
                _context.next = 10;
                return src["default"].subtle.importKey('raw', strongPwd, {
                  name: 'AES-GCM'
              ...
              case 13:
                ...
                data = src.Utils.encode(JSON.stringify({
                  publicKey: keyPair.publicKey,
                  privateKey: keyPair.privateKey
                }));
                _context.t0 = Uint8Array;
                _context.next = 18;
                return src["default"].subtle.encrypt({
                  name: 'AES-GCM',
                  iv: iv,
                  tagLength: 128
                }, key, data);
              ...
              case 18:
                ...
                encrypted = new _context.t0(_context.t1);
                this._exportableEncryptedKey = {
                  version: CURRENT_KEY_VERSION,
                  iv: src.Utils.toBase64(iv),
                  salt: src.Utils.toBase64(salt),
                  data: src.Utils.toBase64(encrypted)
                };
    ...
    key: "exportKey",
    value: function () {
      var _exportKey = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2() {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.t0 = CURRENT_KEY_VERSION;
                _context2.next = 4;
                return src["default"].subtle.exportKey('jwk', this._cryptoKeyPair.publicKey);

              case 4:
                _context2.t1 = _context2.sent;
                _context2.next = 7;
                return src["default"].subtle.exportKey('jwk', this._cryptoKeyPair.privateKey);

              case 7:
                _context2.t2 = _context2.sent;
                this._exportableKey = {
                  version: _context2.t0,
                  publicKey: _context2.t1,
                  privateKey: _context2.t2
                };

              case 9:
                return _context2.abrupt("return", this._exportableKey);
    ...
    value: function () {
      var _exportEncryptedKey = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3() {
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                return _context3.abrupt("return", this._exportableEncryptedKey);
      ...
      function exportEncryptedKey() {
        return _exportEncryptedKey.apply(this, arguments);
      }

      return exportEncryptedKey;
    }()
  }, {
    key: "getRawPublicKey",
    value: function () {
      var _getRawPublicKey = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee4() {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return src["default"].subtle.exportKey('raw', this._cryptoKeyPair.publicKey);

              case 4:
                _context4.t1 = _context4.sent;
                this._rawPublicKey = new _context4.t0(_context4.t1).subarray(1);

              case 6:
                return _context4.abrupt("return", this._rawPublicKey);
      ...
      function getRawPublicKey() {
        return _getRawPublicKey.apply(this, arguments);
      }

      return getRawPublicKey;
    }()
  }, {
    key: "getRawPublicKeyHex",
    value: function () {
      var _getRawPublicKeyHex = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee5() {
        var delimiter,
            _args5 = arguments;
        return regenerator_default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                delimiter = _args5.length > 0 && _args5[0] !== undefined ? _args5[0] : '';
                _context5.t0 = src.Utils;
                _context5.next = 4;
                return this.getRawPublicKey();

              case 4:
                _context5.t1 = _context5.sent;
                _context5.t2 = delimiter;
                return _context5.abrupt("return", _context5.t0.toHex.call(_context5.t0, _context5.t1, _context5.t2));
      ...
      function getRawPublicKeyHex() {
        return _getRawPublicKeyHex.apply(this, arguments);
      }

      return getRawPublicKeyHex;
    }()
  }], [{
    key: "createKey",
    value: function () {
      var _createKey = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee6() {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.t0 = Key;
                _context6.next = 3;
                return src["default"].subtle.generateKey({
                  name: 'ECDSA',
                  namedCurve: 'P-256'
                }, true, ['sign', 'verify']);
    ...
    key: "importKey",
    value: function () {
      var _importKey = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee7(exportableKey) {
        var publicKey, privateKey;
        return regenerator_default().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return src["default"].subtle.importKey('jwk', exportableKey.publicKey, {
                  name: 'ECDSA',
                  namedCurve: 'P-256'
                }, true, ['verify']);
              ...
              case 2:
                ...
                _context7.next = 5;
                return src["default"].subtle.importKey('jwk', exportableKey.privateKey, {
                  name: 'ECDSA',
                  namedCurve: 'P-256'
                }, true, ['sign']);
              ...
              case 5:
                ...
                return _context7.abrupt("return", new Key({
                  publicKey: publicKey,
    ...
    key: "importRawKey",
    value: function () {
      var _importRawKey = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee8(pubKeyRaw, priKeyRaw) {
        var x, y, d, publicKey, privateKey;
        return regenerator_default().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                x = src.Utils.toBase64(pubKeyRaw.subarray(0, 32), true).split('=')[0];
                y = src.Utils.toBase64(pubKeyRaw.subarray(32), true).split('=')[0];
                d = src.Utils.toBase64(priKeyRaw, true).split('=')[0];
                _context8.next = 7;
                return src["default"].subtle.importKey('jwk', {
                  crv: 'P-256',
                  kty: 'EC',
                  x: x,
                  y: y
              ...
              case 10:
                ...
                return _context8.abrupt("return", new Key({
                  publicKey: publicKey,
                  privateKey: privateKey
                }));
    ...
    key: "importEncryptedKeyPair",
    value: function () {
      var _importEncryptedKeyPair = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee10(inputEncryptedKeyPair, pwd) {
        var _inputEncryptedKeyPai;

        var decryptV2, _ref2, _encryptedKey$encrypt, encryptedKey, decrypted, publicKey, privateKey, newKey, _encryptedKey, _decrypted, obj, _publicKey, _privateKey;

        return regenerator_default().wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                decryptV2 = /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee9(inputKeyPair) {
                    var iv, salt, encrypted, weakpwd, strongPwd, aesKey, decrypted;
                    return regenerator_default().wrap(function _callee9$(_context9) {
                      while (1) {
                        switch (_context9.prev = _context9.next) {
                          case 0:
                            iv = src.Utils.fromBase64(inputKeyPair.iv);
                            salt = src.Utils.fromBase64(inputKeyPair.salt);
                            encrypted = src.Utils.fromBase64(inputKeyPair.data);
                            weakpwd = src.Utils.encode(pwd);
                            _context9.next = 6;
                            return src.Utils.hash(src.Utils.concatBytes(salt, weakpwd));

                          case 6:
                            strongPwd = _context9.sent;
                            _context9.next = 9;
                            return src["default"].subtle.importKey('raw', strongPwd, {
                              name: 'AES-GCM'
                            }, false, ['encrypt', 'decrypt']);
                          ...
                          case 9:
                            ...
                            _context9.next = 14;
                            return src["default"].subtle.decrypt({
                              name: 'AES-GCM',
                              iv: iv,
                              tagLength: 128
                            }, aesKey, encrypted);
                          ...
                          case 14:
                            ...
                            decrypted = new _context9.t0(_context9.t1);
                            _context9.next = 21;
                            break;

                          case 18:
                            _context9.prev = 18;
                            _context9.t2 = _context9["catch"](10);
                  ...
                  return function decryptV2(_x7) {
                    return _ref.apply(this, arguments);
                  };
                }();

                _context10.t0 = parseInt("".concat((_inputEncryptedKeyPai = inputEncryptedKeyPair.version) !== null && _inputEncryptedKeyPai !== void 0 ? _inputEncryptedKeyPai : 0));
                _context10.next = _context10.t0 === 0 ? 4 : _context10.t0 === 1 ? 4 : _context10.t0 === 2 ? 18 : 30;
                break;

              case 4:
                encryptedKey = inputEncryptedKeyPair;
                _context10.next = 7;
                return decryptV2({
                  iv: encryptedKey.iv,
                  salt: encryptedKey.salt,
                  data: (_ref2 = (_encryptedKey$encrypt = encryptedKey.encryptedKeys) !== null && _encryptedKey$encrypt !== void 0 ? _encryptedKey$encrypt : encryptedKey.encryptedKeyPair) !== null && _ref2 !== void 0 ? _ref2 : ''
                });

              case 7:
                decrypted = _context10.sent;
                _context10.next = 10;
                return src["default"].subtle.importKey('raw', decrypted.subarray(0, 65), {
                  name: 'ECDSA',
                  namedCurve: 'P-256'
                }, true, ['verify']);
              ...
              case 10:
                ...
                _context10.next = 13;
                return src["default"].subtle.importKey('pkcs8', decrypted.subarray(65), {
                  name: 'ECDSA',
                  namedCurve: 'P-256'
                }, true, ['sign']);
              ...
              case 13:
                ...
                _context10.next = 17;
                return newKey.seal(pwd);

              case 17:
                return _context10.abrupt("return", _context10.sent);

              case 18:
                _encryptedKey = inputEncryptedKeyPair;
                _context10.next = 21;
                return decryptV2(_encryptedKey);

              case 21:
                _decrypted = _context10.sent;
                obj = JSON.parse(src.Utils.decode(_decrypted));
                _context10.next = 25;
                return src["default"].subtle.importKey('jwk', obj.publicKey, {
                  name: 'ECDSA',
                  namedCurve: 'P-256'
                }, true, ['verify']);

              case 25:
                _publicKey = _context10.sent;
                _context10.next = 28;
                return src["default"].subtle.importKey('jwk', obj.privateKey, {
                  name: 'ECDSA',
                  namedCurve: 'P-256'
                }, true, ['sign']);

              case 28:
                _privateKey = _context10.sent;
                return _context10.abrupt("return", new Key({
      ...
      function importEncryptedKeyPair(_x5, _x6) {
        return _importEncryptedKeyPair.apply(this, arguments);
      }

      return importEncryptedKeyPair;
    }()
  }]);
...
var external_ws_ = __webpack_require__(836);
var external_ws_default = /*#__PURE__*/__webpack_require__.n(external_ws_);
;// CONCATENATED MODULE: ./src/secretarium.socket.ts


var selectSocket = function selectSocket() {
  var nativeSocket = typeof WebSocket !== 'undefined' ? WebSocket : undefined;
  return nativeSocket || (external_ws_default());
};

/* harmony default export */ const secretarium_socket = (selectSocket());
;// CONCATENATED MODULE: ./src/nng.websocket.ts
...
var WS = /*#__PURE__*/function () {
  function WS() {
    ...
    _defineProperty(this, "_requiresHop", void 0);
  ...
  _createClass(WS, [{
    ...
    get: function get() {
      ...
      return ((_this$_socket = this._socket) === null || _this$_socket === void 0 ? void 0 : _this$_socket.readyState) || ConnectionState.closed;
    }
  }, {
    key: "bufferedAmount",
    get: function get() {
      ...
      return ((_this$_socket2 = this._socket) === null || _this$_socket2 === void 0 ? void 0 : _this$_socket2.bufferedAmount) || 0;
    }
  }, {
    key: "_addHop",
    value: function _addHop(data) {
    ...
    value: function connect(url, protocol) {
      try {
        var _this$_socket3, _this$_socket4, _this$_socket5, _this$_socket6;

        var s = new secretarium_socket(url, [protocol]);
        s.binaryType = 'arraybuffer';
        s.onopen = ((_this$_socket3 = this._socket) === null || _this$_socket3 === void 0 ? void 0 : _this$_socket3.onopen) || this._handlers.onopen || null;
        s.onclose = ((_this$_socket4 = this._socket) === null || _this$_socket4 === void 0 ? void 0 : _this$_socket4.onclose) || this._handlers.onclose || null;
        s.onmessage = ((_this$_socket5 = this._socket) === null || _this$_socket5 === void 0 ? void 0 : _this$_socket5.onmessage) || this._handlers.onmessage || null;
        s.onerror = ((_this$_socket6 = this._socket) === null || _this$_socket6 === void 0 ? void 0 : _this$_socket6.onerror) || this._handlers.onerror || null;
        this._requiresHop = protocol === Protocol.pair1;
        this._socket = s;
      } catch (e) {
        var _this$_socket7, _onerror;

        onerror = ((_this$_socket7 = this._socket) === null || _this$_socket7 === void 0 ? void 0 : _this$_socket7.onerror) || this._handlers.onerror || null;
        (_onerror = onerror) === null || _onerror === void 0 ? void 0 : _onerror(e);
      }
    ...
    value: function onmessage(handler) {
      ...
      this._handlers.onmessage = function (e) {
        ...
        if (_this._requiresHop) data = data.subarray(4);
    ...
    value: function send(data) {
      ...
      (_this$_socket8 = this._socket) === null || _this$_socket8 === void 0 ? void 0 : _this$_socket8.send(data);
      return this;
    }
  }, {
    key: "close",
    value: function close() {
      ...
      (_this$_socket9 = this._socket) === null || _this$_socket9 === void 0 ? void 0 : _this$_socket9.close();
      return this;
    }
  }]);
...
;// CONCATENATED MODULE: ./src/secretarium.connector.ts
...
var SCPSession = function SCPSession(iv, cryptoKey) {
  _classCallCheck(this, SCPSession);

  _defineProperty(this, "iv", void 0);

  _defineProperty(this, "cryptoKey", void 0);

  this.iv = iv;
  this.cryptoKey = cryptoKey;
};

var SCP = /*#__PURE__*/function () {
  function SCP(options) {
    _classCallCheck(this, SCP);

    _defineProperty(this, "_socket", null);

    _defineProperty(this, "_connectionState", ConnectionState.closed);

    _defineProperty(this, "_onStateChange", null);
  ...
  _createClass(SCP, [{
    ...
    key: "_encrypt",
    value: function () {
      var _encrypt2 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(data) {
        var ivOffset, iv, encrypted;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 2:
                ivOffset = src.Utils.getRandomBytes(16);
                iv = src.Utils.incrementBy(this._session.iv, ivOffset).subarray(0, 12);
                _context.t0 = Uint8Array;
                _context.next = 7;
                return src["default"].subtle.encrypt({
                  name: 'AES-GCM',
              ...
              case 7:
                _context.t1 = _context.sent;
                encrypted = new _context.t0(_context.t1);
                return _context.abrupt("return", src.Utils.concatBytes(ivOffset, encrypted));
    ...
    key: "_decrypt",
    value: function () {
      var _decrypt2 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(data) {
        var iv;
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                iv = src.Utils.incrementBy(this._session.iv, data.subarray(0, 16)).subarray(0, 12);
    ...
    key: "_notify",
    value: function _notify(json) {
      var _z$onAcknowledged, _z$onProposed, _z$onCommitted, _z$onExecuted, _z$onError;

      try {
        var _this$_options$logger, _this$_options$logger2;

        var _o = JSON.parse(json);

        (_this$_options$logger = this._options.logger) === null || _this$_options$logger === void 0 ? void 0 : (_this$_options$logger2 = _this$_options$logger.debug) === null || _this$_options$logger2 === void 0 ? void 0 : _this$_options$logger2.call(_this$_options$logger, 'Secretarium received:', _o);

        if (_o !== null && _o.requestId) {
          var x = this._requests[_o.requestId];

          if (!x) {
            var _this$_options$logger3, _this$_options$logger4;

            (_this$_options$logger3 = this._options.logger) === null || _this$_options$logger3 === void 0 ? void 0 : (_this$_options$logger4 = _this$_options$logger3.warn) === null || _this$_options$logger4 === void 0 ? void 0 : _this$_options$logger4.call(_this$_options$logger3, 'Unexpected notification: ' + json);
            return;
          }
          ...
          if (_o.error) {
            ...
            (_x$onError = x.onError) === null || _x$onError === void 0 ? void 0 : _x$onError.forEach(function (cb) {
              return cb(_o.error, _o.requestId);
            });
            x.failed = true;
            x.promise.reject(_o.error);
          } else if (_o.result) {
            var _x$onResult;

            (_x$onResult = x.onResult) === null || _x$onResult === void 0 ? void 0 : _x$onResult.forEach(function (cb) {
              return cb(_o.result, _o.requestId);
            });
            x.promise.resolve(_o.result);
          } else if (_o.state) {
            if (x.failed === true) return;
            var z = x;

            switch (_o.state.toLowerCase()) {
              case 'acknowledged':
                (_z$onAcknowledged = z.onAcknowledged) === null || _z$onAcknowledged === void 0 ? void 0 : _z$onAcknowledged.forEach(function (cb) {
                  return cb(_o.requestId);
                });
                break;

              case 'proposed':
                (_z$onProposed = z.onProposed) === null || _z$onProposed === void 0 ? void 0 : _z$onProposed.forEach(function (cb) {
                  return cb(_o.requestId);
                });
                break;

              case 'committed':
                (_z$onCommitted = z.onCommitted) === null || _z$onCommitted === void 0 ? void 0 : _z$onCommitted.forEach(function (cb) {
                  return cb(_o.requestId);
                });
                break;

              case 'executed':
                (_z$onExecuted = z.onExecuted) === null || _z$onExecuted === void 0 ? void 0 : _z$onExecuted.forEach(function (cb) {
                  return cb(_o.requestId);
                });
                z.promise.resolve(_o.result);
                break;

              case 'failed':
                (_z$onError = z.onError) === null || _z$onError === void 0 ? void 0 : _z$onError.forEach(function (cb) {
                  return cb(ErrorMessage[ErrorCodes.ETRANSFIL], _o.requestId);
                });
                z.failed = true;
                z.promise.reject(_o.error);
                break;
        ...
        var _this$_options$logger5, _this$_options$logger6;

        var m = "Error '".concat(e.message, "' when received '").concat(JSON.stringify(json), "'");
        if (this._onError) this._onError(m);else (_this$_options$logger5 = this._options.logger) === null || _this$_options$logger5 === void 0 ? void 0 : (_this$_options$logger6 = _this$_options$logger5.error) === null || _this$_options$logger6 === void 0 ? void 0 : _this$_options$logger6.call(_this$_options$logger5, m);
      }
    }
  }, {
    key: "_computeProofOfWork",
    value: function _computeProofOfWork(nonce) {
    ...
    get: function get() {
      ...
      return ((_this$_socket = this._socket) === null || _this$_socket === void 0 ? void 0 : _this$_socket.bufferedAmount) || 0;
    }
  }, {
    key: "connect",
    value: function connect(url, userKey, knownTrustedKey) {
      var _this = this;

      var protocol = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : Protocol.pair1;
      if (this._socket && this._socket.state > ConnectionState.closing) this._socket.close();

      this._updateState(ConnectionState.connecting);

      var trustedKey = typeof knownTrustedKey === 'string' ? Uint8Array.from(src.Utils.fromBase64(knownTrustedKey)) : knownTrustedKey;
      var socket = this._socket = new WS();
      var ecdh;
      var ecdhPubKeyRaw;
      var serverEcdsaPubKey;
      return new Promise(function (resolve, reject) {
        new Promise(function (resolve, reject) {
          ...
          socket.onopen(function (x) {
            clearTimeout(tId);
            resolve(x);
          }).onerror(reject).onclose(reject).connect(url, protocol);
        }).then( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3() {
          return regenerator_default().wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  socket.onerror(function () {
                    _this._updateState(ConnectionState.closed);
                  }).onclose(function () {
                    _this._updateState(ConnectionState.closed);
                  });
                  _context3.next = 3;
                ...
                case 3:
                  ...
                  return _context3.abrupt("return", Promise.reject(ErrorMessage[ErrorCodes.EECDHGENF]));

                case 6:
                  _context3.t0 = Uint8Array;
                  _context3.next = 9;
                  return src["default"].subtle.exportKey('raw', ecdh.publicKey);

                case 9:
                  _context3.t1 = _context3.sent;
                  ecdhPubKeyRaw = new _context3.t0(_context3.t1).subarray(1);
          ...
          var clientProofOfWork = src.Utils.concatBytesArrays([pow, trustedKey]);
          return new Promise(function (resolve, reject) {
            var tId = setTimeout(function () {
          ...
          var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee4(serverIdentity) {
            var preMasterSecret, serverEcdhPubKey, knownTrustedKeyPath, i, _key, proof, keyChild, ecdsaKey, commonSecret, sha256Common, symmetricKey, iv, key, cryptoKey, cryptoKeyPair, publicKeyRaw, nonce, signedNonce, clientProofOfIdentity, encryptedClientProofOfIdentity;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    _context4.next = 3;
                    return src["default"].subtle.importKey('raw', src.Utils.concatBytes(
                    /*uncompressed*/
                    Uint8Array.from([4]), serverIdentity.subarray(32, 96)), {
                      name: 'ECDH',
                      namedCurve: 'P-256'
                    }, false, []);

                  case 3:
                    serverEcdhPubKey = _context4.sent;
                    _context4.next = 6;
                    return src["default"].subtle.importKey('raw', src.Utils.concatBytes(
                    /*uncompressed*/
                    Uint8Array.from([4]), serverIdentity.subarray(serverIdentity.length - 64)), {
                      name: 'ECDSA',
                      namedCurve: 'P-256'
                    }, false, ['verify']);

                  case 6:
                    serverEcdsaPubKey = _context4.sent;
                    ...
                    if (src.Utils.sequenceEqual(trustedKey, knownTrustedKeyPath)) {
                      _context4.next = 11;
                      break;
                    }
                  ...
                  case 14:
                    if (!(i < knownTrustedKeyPath.length - 64)) {
                      _context4.next = 28;
                      break;
                    }

                    _key = knownTrustedKeyPath.subarray(i, 64);
                    proof = knownTrustedKeyPath.subarray(i + 64, 64);
                    keyChild = knownTrustedKeyPath.subarray(i + 128, 64);
                    _context4.next = 20;
                    return src["default"].subtle.importKey('raw', src.Utils.concatBytes(
                    /*uncompressed*/
                    Uint8Array.from([4]), _key), {
                      name: 'ECDSA',
                      namedCurve: 'P-256'
                    }, false, ['verify']);

                  case 20:
                    ecdsaKey = _context4.sent;
                    _context4.next = 23;
                    return src["default"].subtle.verify({
                      name: 'ECDSA',
                      hash: {
                        name: 'SHA-256'
                      }
                    }, ecdsaKey, proof, keyChild);
                  ...
                  case 23:
                    ...
                    throw new Error("".concat(ErrorMessage[ErrorCodes.ETINSRVIC]).concat(i));
                  ...
                  case 28:
                    ...
                    return _context4.abrupt("return", Promise.reject(ErrorMessage[ErrorCodes.EECDHGENF]));

                  case 30:
                    _context4.next = 32;
                    return src["default"].subtle.deriveBits({
                      name: 'ECDH',
                      namedCurve: 'P-256',
                  ...
                  case 32:
                    commonSecret = _context4.sent;
                    _context4.t0 = Uint8Array;
                    _context4.next = 36;
                    return src["default"].subtle.digest({
                      name: 'SHA-256'
                    }, commonSecret);

                  case 36:
                    _context4.t1 = _context4.sent;
                    sha256Common = new _context4.t0(_context4.t1);
                    symmetricKey = src.Utils.xor(preMasterSecret, sha256Common);
                    iv = symmetricKey.subarray(16);
                    key = symmetricKey.subarray(0, 16);
                    _context4.next = 43;
                    return src["default"].subtle.importKey('raw', key, {
                      name: 'AES-GCM'
                    }, false, ['encrypt', 'decrypt']);

                  case 43:
                    cryptoKey = _context4.sent;
                    _this._session = new SCPSession(iv, cryptoKey);
                    cryptoKeyPair = userKey.getCryptoKeyPair();
                    _context4.next = 48;
                    return userKey.getRawPublicKey();

                  case 48:
                    publicKeyRaw = _context4.sent;

                    if (!(!userKey || !(cryptoKeyPair !== null && cryptoKeyPair !== void 0 && cryptoKeyPair.privateKey) || !publicKeyRaw)) {
                      _context4.next = 51;
                      break;
                    }
                  ...
                  case 51:
                    nonce = src.Utils.getRandomBytes(32);
                    _context4.t2 = Uint8Array;
                    _context4.next = 55;
                    return src["default"].subtle.sign({
                      name: 'ECDSA',
                      hash: {
                        name: 'SHA-256'
                      }
                    }, cryptoKeyPair.privateKey, nonce);

                  case 55:
                    _context4.t3 = _context4.sent;
                    signedNonce = new _context4.t2(_context4.t3);
                    clientProofOfIdentity = src.Utils.concatBytesArrays([nonce, ecdhPubKeyRaw, publicKeyRaw, signedNonce]);
                    _context4.next = 60;
                    return _this._encrypt(clientProofOfIdentity);

                  case 60:
                    encryptedClientProofOfIdentity = _context4.sent;
          ...
          var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee6(serverProofOfIdentityEncrypted) {
            ...
            return regenerator_default().wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    _context6.next = 2;
                    return _this._decrypt(serverProofOfIdentityEncrypted);

                  case 2:
                    serverProofOfIdentity = _context6.sent;
                    welcome = src.Utils.encode(Secrets.SRTWELCOME);
                    toVerify = src.Utils.concatBytes(serverProofOfIdentity.subarray(0, 32), welcome);
                  ...
                  case 11:
                    socket.onmessage( /*#__PURE__*/function () {
                      var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee5(encrypted) {
                        var data, json;
                        return regenerator_default().wrap(function _callee5$(_context5) {
                          while (1) {
                            switch (_context5.prev = _context5.next) {
                              case 0:
                                _context5.next = 2;
                                return _this._decrypt(encrypted);

                              case 2:
                                data = _context5.sent;
                                json = src.Utils.decode(data);
                    ...
                    _this._updateState(ConnectionState.secure);
          ...
          var _ref5, _e$message;

          _this._updateState(ConnectionState.closing);

          socket.close();

          _this._updateState(ConnectionState.closed);

          var error = (_ref5 = (_e$message = e.message) !== null && _e$message !== void 0 ? _e$message : e.type) !== null && _ref5 !== void 0 ? _ref5 : e.toString();
          reject("".concat(ErrorMessage[ErrorCodes.EUNABLCON]).concat(error));
        });
      });
    }
  }, {
    ...
    key: "onStateChange",
    value: function onStateChange(handler) {
      this._onStateChange = handler;
      return this;
    }
  }, {
    key: "newQuery",
    value: function newQuery(app, command, requestId, args) {
      var _this2 = this;

      var cbs = {};
      var pm = new Promise(function (resolve, reject) {
        _this2._requests[requestId] = cbs = {
          onError: [],
          onResult: [],
          promise: {
            resolve: resolve,
      ...
      var query = {
        ...
        onResult: function onResult(x) {
          (cbs.onResult = cbs.onResult || []).push(x);
          return query;
        },
        send: function send() {
          _this2.send(app, command, requestId, args);
    ...
    key: "newTx",
    value: function newTx(app, command, requestId, args) {
      var _this3 = this;

      var cbs;
      var pm = new Promise(function (resolve, reject) {
        _this3._requests[requestId] = cbs = {
          onError: [],
          onResult: [],
          onAcknowledged: [],
          onCommitted: [],
      ...
      var tx = {
        ...
        onAcknowledged: function onAcknowledged(x) {
          (cbs.onAcknowledged = cbs.onAcknowledged || []).push(x);
          return tx;
        },
        onProposed: function onProposed(x) {
          (cbs.onProposed = cbs.onProposed || []).push(x);
          return tx;
        },
        onCommitted: function onCommitted(x) {
          (cbs.onCommitted = cbs.onCommitted || []).push(x);
          return tx;
        },
        onExecuted: function onExecuted(x) {
        ...
        send: function send() {
          _this3.send(app, command, requestId, args);
    ...
    key: "send",
    value: function () {
      var _send = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee7(app, command, requestId, args) {
        var _this$_requests$reque, z, query, data, encrypted, _this$_options$logger7, _this$_options$logger8;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                z = (_this$_requests$reque = this._requests[requestId]) === null || _this$_requests$reque === void 0 ? void 0 : _this$_requests$reque.onError;
                ...
                z.forEach(function (cb) {
                  return cb(ErrorMessage[ErrorCodes.ENOTCONNT], requestId);
                });
                return _context7.abrupt("return");

              case 7:
                throw new Error(ErrorMessage[ErrorCodes.ENOTCONNT]);
              ...
              case 12:
                ...
                if (app !== '__local__') {
                  (_this$_options$logger7 = this._options.logger) === null || _this$_options$logger7 === void 0 ? void 0 : (_this$_options$logger8 = _this$_options$logger7.debug) === null || _this$_options$logger8 === void 0 ? void 0 : _this$_options$logger8.call(_this$_options$logger7, 'Secretarium sending:', JSON.parse(query));
